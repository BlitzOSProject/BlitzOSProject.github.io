...
!
! this routine reads character from IO and returns it.
!
getChar:
...
busywaitGetChar:				!     BUSYWAIT:
	load	[r1],r3		!       r3 := serial status word
	btst	0x00000001,r3   !       if status[outputReady] == 0 then
	be	busywaitGetChar	!       .    goto BUSYWAIT

	load	[r2],r4		!     r4:= the character
	storeb   r4,[r15+20]
	pop	r4			! restore regs
	pop	r3			! .
	pop	r2			! .
