header System
  ...
  -- force all threads to acquire the lock before printing.  Another approach -- is to explicitly disable interrupts before making a series of printing -- calls and then restore the interrupt status after printing is complete. functions
  functions
  ...
  functions
    ...
    external getChar () returns char -- Returns char from IO input device
